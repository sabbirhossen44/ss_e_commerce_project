...
<head>
    ...
    @foreach (Request::segments() as $segment)
        <title>SH-Shop - {{ucwords($segment)}}</title>
    @endforeach
                            ...
                            <div class="content-inner">
                                ...
                                <div class="contact-info">
                                    ...
                                    <ul>
                                        <li><span class="flaticon-phone-call"></span><a
                                                href="tel:{{$web_info->number_link}}">{{$web_info->number}}</a></li>
                                ...
                                <div class="oc-social">
                                    <ul>
                                        ...
                                        <li><a href="{{$web_info->linkedin}}"><i class="fab fa-linkedin-in"></i></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="oc-bottom">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer-logo">
                            <a href="{{route('home')}}"><img src="{{asset('uploads/webinfo/' . $web_info->logo)}}"
                                    alt=""></a>
                        </div>
                    </div>
                </div>
